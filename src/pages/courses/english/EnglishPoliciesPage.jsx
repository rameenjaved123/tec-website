...
const policies = [
  ...
  { label: 'Sexual Harassment Policy (EL Courses)',                         url: '/assets/documents/policies/sexual-harassment-el.pdf' },
  { label: 'Staff Development Policy (EL Courses)',                         url: '/assets/documents/policies/staff-development-el.pdf' },
  { label: 'Staff Recruitment Policy (EL Courses)',                         url: '/assets/documents/policies/staff-recruitment-el.pdf' },
  { label: 'Student Support Policy (EL Courses)',                           url: '/assets/documents/policies/student-support-el.pdf' },
