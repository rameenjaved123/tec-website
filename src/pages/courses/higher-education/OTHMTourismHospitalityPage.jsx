        ...
        {activeTab === 'Course Units' && (
          <div className="al4-units-list">
            ...
            <ul className="al4-bullets">
              ...
              <li>Management Accounting (20 Credits)</li>
              <li>Management of Human Resources (20 Credits)</li>
              <li>Customer Relationship Management (20 Credits)</li>
              <li>Contemporary Issues in Tourism and Hospitality (20 Credits)</li>
            </ul>
          </div>
        )}
