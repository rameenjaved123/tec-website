...
const facts = [
  { icon: <Clock size={22} />, label: '270 Hours / Onsite' },
  { icon: <Calendar size={22} />, label: 'Intake: Every Month' },
  { icon: <Award size={22} />, label: 'Awarding Body: OTHM' },
  { icon: <FileText size={22} />, label: 'Level 3 Certificate · 26 Credits' },
];

const tabs = ['Overview', 'Course Units', 'Course Fees'];

export default function OTHMFacialTreatmentsL3Page() {
  ...
  return (
    <div className="inner-page page-enter al4-page">
      ...
      <PageHero
        ...
        bgImage="https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=1600&q=80"
      />
      ...
      <div className="container al4-tab-content-wrap">
        ...
        {activeTab === 'Overview' && (
          <div className="al4-overview">
            <p><strong>The OTHM Level 3 Certificate in Facial Treatments provides learners with the knowledge and understanding required to provide facial treatments.</strong></p>
            <p>Successful completion of this qualification will equip learners with the underpinning knowledge and skills required to succeed in employment or further studies in the beauty and complementary therapy sector.</p>
          </div>
        )}

        {activeTab === 'Course Units' && (
          <div className="al4-units-list">
            <p style={{ fontWeight: 700, marginBottom: 10 }}>Units you will study (26 credits)</p>
            <ul className="al4-bullets">
              ...
              <li>Anatomy and Physiology for Facial Treatments (4 Credits)</li>
              <li>Provide Facial Treatments (8 Credits)</li>
            </ul>
          </div>
        )}
      ...
      <div className="container al4-section">
        ...
        <p style={{ marginTop: 8 }}>Learners who are not from a majority English-speaking country must provide evidence of English language competency.</p>
      ...
      <div className="container al4-section">
        ...
        <p>Successful completion of the OTHM Level 3 beauty qualifications provides learners with opportunities for both workplace and academic progression, including further OTHM Beauty and Complementary Therapy qualifications.</p>
      </div>
